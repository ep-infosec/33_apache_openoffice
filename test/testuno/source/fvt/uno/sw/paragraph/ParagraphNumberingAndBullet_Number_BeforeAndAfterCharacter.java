...
public class ParagraphNumberingAndBullet_Number_BeforeAndAfterCharacter {
	 ...
	 * 2.insert some text
	 * 3.set paragraph numbering before and after character
	 * 4.save and close the document
	 * 5.reload the saved document and check the paragraph numbering before and after character
	 */	
	@Test
	public void testNumberingBulletBeforeAndAfterCharacter() throws Exception {
		...
		propsRule[1].Name = "Prefix";
		propsRule[1].Value = "#$%&";
		propsRule[0].Name = "Suffix";
		propsRule[0].Value = "abcd";	
		...
		assertEquals("assert numbering and bullet","abcd",propsRule_assert_odt[3].Value);
		...
		assertEquals("assert numbering and bullet","abcd",propsRule_assert_doc[3].Value);
	}
}
