...
public class ParagraphNumberingAndBullet_Number_StartWith {
	...
	public void testNumberingBulletStartWith() throws Exception {
		...
		assertEquals("assert numbering and bullet","StartWith",propsRule_assert_odt[5].Name);
		assertEquals("assert numbering and bullet",(short)5,propsRule_assert_odt[5].Value);
		...
		//verify paragraph numbering and bullet alignment
		assertEquals("assert numbering and bullet","StartWith",propsRule_assert_doc[5].Name);
		assertEquals("assert numbering and bullet",(short)5,propsRule_assert_doc[5].Value);
