...
public class ParagraphNumberingAndBullet_Graphic_Alignment {
	...
	public void testNumberingBullet_Graphic_Align_BottomofBaseline() throws Exception {
		...
		assertEquals("assert numbering and bullet","GraphicURL",propsRule_assert_doc[12].Name);
	...
	public void testNumberingBullet_Graphic_Align_TopofLine() throws Exception {
		...
		assertEquals("assert numbering and bullet",FileUtil.getUrl(Testspace.prepareData("uno/coffee_1.gif")),propsRule_assert_doc[12].Value);
		assertEquals("assert numbering and bullet","VertOrient",propsRule_assert_doc[15].Name);
		assertEquals("assert numbering and bullet",VertOrientation.LINE_TOP,propsRule_assert_doc[15].Value);
	}
}
